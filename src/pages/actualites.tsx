...
const categories = [
  { name: "Tous", count: actualites.length, color: "bg-gray-100 text-gray-800" },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center mb-12">
            ...
            <h2 className="text-3xl font-light text-gray-900">Articles à la Une</h2>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center mb-12">
            ...
            <h2 className="text-3xl font-light text-gray-900">Toutes les Actualités</h2>
          </div>
