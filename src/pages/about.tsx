...
const values = [
  {
    ...
    description: "Nous nous engageons à fournir des soins de la plus haute qualité avec compassion et professionnalisme."
  },
  {
    icon: Users,
    title: "Accessibilité pour tous",
    description: "Notre mission est de rendre les soins de santé accessibles à toute la communauté sans discrimination."
  },
  {
    icon: Award,
    title: "Innovation continue",
    description: "Nous investissons dans les technologies modernes et la formation continue de notre personnel."
  },
  {
    icon: Target,
    title: "Engagement communautaire",
    description: "Nous travaillons activement avec la communauté locale pour améliorer la santé publique."
  }
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-4xl font-light text-gray-900">Notre Histoire</h2>
              </div>
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p className="text-lg">
                  Fondé en 1954, l'EPHD de Bingerville a été créé pour répondre aux besoins sanitaires 
                  croissants de la région d'Abidjan. Situé dans le quartier Blanchon, notre établissement 
                  a évolué pour devenir un centre de référence départemental.
                </p>
                <p>
                  Au fil des décennies, nous avons constamment modernisé nos équipements et renforcé 
                  notre expertise médicale. Notre collaboration avec l'Hôpital psychiatrique de Bingerville 
                  et l'Hôpital Mère-Enfant Dominique Ouattara témoigne de notre engagement dans 
                  un écosystème de santé intégré.
                </p>
                <p>
                  Aujourd'hui, nous sommes fiers de notre statut d'établissement public, 
                  garant d'une mission de service public au cœur de nos valeurs.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <Card className="border-0 shadow-xl rounded-3xl overflow-hidden bg-gradient-to-br from-blue-600 to-blue-700 text-white">
              <CardContent className="p-12">
                <Target className="h-12 w-12 mb-6 text-blue-200" />
                <h3 className="text-3xl font-bold mb-6">Notre Mission</h3>
                <p className="text-lg leading-relaxed text-blue-100">
                  Fournir des soins de santé de qualité, accessibles et humains à tous les patients, 
                  en mettant l'accent sur l'excellence médicale, la sécurité des patients et 
                  l'innovation continue dans nos pratiques.
                </p>
              </CardContent>
            </Card>

            <Card className="border-0 shadow-xl rounded-3xl overflow-hidden bg-gradient-to-br from-emerald-600 to-emerald-700 text-white">
              <CardContent className="p-12">
                ...
                <p className="text-lg leading-relaxed text-emerald-100">
                  Être reconnu comme l'établissement de santé de référence en Côte d'Ivoire, 
                  alliant excellence clinique, innovation technologique et approche humaine 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-6">Nos Valeurs</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Les principes fondamentaux qui guident chacune de nos actions 
              et définissent notre engagement envers nos patients et notre communauté.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => {
              ...
              return (
                <Card 
                  key={index}
                  className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 rounded-2xl group bg-gradient-to-br from-white to-gray-50/50"
                >
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-16">
      <div className="flex items-center justify-center mb-6">
        ...
        <h2 className="text-4xl font-light text-gray-900">Équipe Dirigeante</h2>
      </div>
      <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
        Une équipe de professionnels expérimentés et dévoués, unis par la passion d'offrir des soins d'excellence.
      </p>
    </div>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
      {leadership.map((leader, index) => (
        <Card
          key={index}
          className="border-0 shadow-lg hover:shadow-xl transition-all duration-500 rounded-2xl overflow-hidden group bg-transparent relative h-96 [perspective:1000px]"
        >
          {/* Conteneur pour les deux faces du card */}
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 via-blue-700 to-emerald-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            Découvrez comment nous pouvons vous accompagner dans vos besoins de santé 
            avec nos services d'excellence et notre approche humaine.
          </p>
